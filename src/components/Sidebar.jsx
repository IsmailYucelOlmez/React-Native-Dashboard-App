  ...
  return (
    ...
    {!settings ? (
      <View className='flex flex-col items-center gap-4 mt-5'>
        ...
        <Pressable onPress={()=>navigateScreen("home")} className={`flex flex-row py-0.5 w-3/4 rounded-xl items-center justify-center ${route.name === "home" ? `bg-[${themeColor}] ` : ''}`} ><Entypo name="home" size={20} color={`${route.name=="home" ? 'white':'black'}`}/><Text className={`ml-3 ${route.name==="home" ? 'text-white text-lg font-semibold':'text-base'} `}>Home</Text></Pressable>
        <Pressable onPress={()=>navigateScreen("customer")} className={`flex flex-row py-1 w-3/4 rounded-xl items-center justify-center ${route.name === "customer" ? `p-1 bg-[${themeColor}] ` : ''}`} ><FontAwesome5 name="user-tag" size={20} color={`${route.name=="customer" ? 'white':'black'}`}/><Text className={`ml-3 ${route.name==="customer" ? 'text-white text-lg font-semibold':'text-base'} `}>Customer</Text></Pressable>
        <Pressable onPress={()=>navigateScreen("employee")} className={`flex flex-row py-1 w-3/4  rounded-xl items-center justify-center ${route.name === "employee" ? `bg-[${themeColor}] ` : ''}`} ><FontAwesome5 name="user-tie" size={20} color={`${route.name=="employee" ? 'white':'black'}`}/><Text  className={`ml-3 ${route.name==="employee" ? 'text-white text-lg font-semibold':'text-base'} `}>Employees</Text></Pressable>
        ...
        <Pressable onPress={()=>navigateScreen("line-chart")} className={`flex flex-row py-1 w-3/4  rounded-xl items-center justify-center ${route.name === "line-chart" ? `bg-[${themeColor}] ` : ''}`} ><AntDesign name="linechart" size={20} color={`${route.name=="line-chart" ? 'white':'black'}`}/><Text  className={`ml-3 ${route.name==="line-chart" ? 'text-white text-lg font-semibold':'text-base'} `}>Line</Text></Pressable>
        <Pressable onPress={()=>navigateScreen("pie-chart")} className={`flex flex-row py-1 w-3/4  rounded-xl items-center justify-center ${route.name === "pie-chart" ? `bg-[${themeColor}] ` : ''}`} ><AntDesign name="piechart" size={20} color={`${route.name=="pie-chart" ? 'white':'black'}`}/><Text  className={`ml-3 ${route.name==="pie-chart" ? 'text-white text-lg font-semibold':'text-base'} `}>Pie</Text></Pressable>
        <Pressable onPress={()=>navigateScreen("bar-chart")} className={`flex flex-row py-1 w-3/4  rounded-xl items-center justify-center ${route.name === "bar-chart" ? `bg-[${themeColor}] ` : ''}`} ><AntDesign name="barschart" size={20} color={`${route.name=="bar-chart" ? 'white':'black'}`}/><Text  className={`ml-3 ${route.name==="bar-chart" ? 'text-white text-lg font-semibold':'text-base'} `}>Bar</Text></Pressable>
        <Pressable onPress={()=>navigateScreen("area-chart")} className={`flex flex-row py-1 w-3/4  rounded-xl items-center justify-center ${route.name === "area-chart" ? `bg-[${themeColor}] ` : ''}`} ><AntDesign name="areachart" size={20} color={`${route.name=="area-chart" ? 'white':'black'}`}/><Text  className={`ml-3 ${route.name==="area-chart" ? 'text-white text-lg font-semibold':'text-base'} `}>Area</Text></Pressable>
        <Pressable onPress={()=>navigateScreen("financial")} className={`flex flex-row py-1 w-3/4  rounded-xl items-center justify-center ${route.name === "financial" ? `bg-[${themeColor}] ` : ''}`} ><FontAwesome5 name="coins" size={20} color={`${route.name=="financial" ? 'white':'black'}`}/><Text  className={`ml-3 ${route.name==="financial" ? 'text-white text-lg font-semibold':'text-base'} `}>Financial</Text></Pressable>
        <Pressable onPress={()=>navigateScreen("pyramid")} className={`flex flex-row py-1 w-3/4  rounded-xl items-center justify-center ${route.name === "pyramid" ? `bg-[${themeColor}] ` : ''}`} ><Ionicons name="triangle" size={20} color={`${route.name=="pyramid" ? 'white':'black'}`}/><Text  className={`ml-3 ${route.name==="pyramid" ? 'text-white text-lg font-semibold':'text-base'} `}>Pyramid</Text></Pressable>
        <Pressable onPress={()=>navigateScreen("stacked")} className={`flex flex-row py-1 w-3/4  rounded-xl items-center justify-center ${route.name === "stacked" ? `bg-[${themeColor}] ` : ''}`} ><MaterialIcons name="stacked-bar-chart" size={20} color={`${route.name=="stacked" ? 'white':'black'}`}/><Text  className={`ml-3 ${route.name==="stacked" ? 'text-white text-lg font-semibold':'text-base'} `}>Stacked</Text></Pressable>
